...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		function showError(itemDiv, msg) {
			...
			K('.ke-service', itemDiv).addClass('ke-error').show().html(K.escape(msg));
		}
	...
	appendFile : function(file) {
		...
		// service
		K('<div class="ke-service">' + self.options.pendingMessage + '</div>').appendTo(statusDiv);
...
/* **********************************
	...
	for debug service to be sent.  The Debug Console adds
